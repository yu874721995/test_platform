...
from test_management.api.EnvManagement_new import EnvListSet
from test_management.api.ProjectManagement import ProjectListSet,TapdProjectListSet
from test_management.api.AccountManagent_new import AccountSetView
...
urlpatterns = [
    ...
    path(r"createEnv", EnvListSet.createEnv),
    path(r"updateEnv", EnvListSet.updateEnv),
    path(r"deleteEnv", EnvListSet.deleteEnv),
    ...
    path(r"loginEnvList", AccountSetView.loginEnvList),
    ...
    path(r"proManageList",ProjectListSet.proManageList),
    ...
    path(r"MysqlConfList",EnvListSet.MysqlConfList),
    path(r"insertMysqlconf",EnvListSet.insertMysqlconf),
    path(r"dingUserlist",ProjectListSet.dingUserlist)
